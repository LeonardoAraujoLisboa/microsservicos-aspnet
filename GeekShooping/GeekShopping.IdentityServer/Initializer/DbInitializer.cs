    ...
    public class DbInitializer : IDbInitializer
    {
        ...
        public void Initialize()
        {
            ...
            ApplicationUser admin = new ApplicationUser()
            {
                ...
                Email = "leo_araujo05@hotmail.com",
                EmailConfirmed = true,
                PhoneNumber = "+55 (79) 99841-8412",
                FirstName = "Leonardo",
                LastName = "Lisboa"
            };

            _user.CreateAsync(admin, "Eusoueuu987!").GetAwaiter().GetResult();
            ...
            _user.CreateAsync(client, "Eusoueuu987!").GetAwaiter().GetResult();
